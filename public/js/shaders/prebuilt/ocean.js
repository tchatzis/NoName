THREE.Ocean = function ( target, options )
{
    THREE.Mesh.call( this, target.geometry );
    ...
    var renderTarget = new THREE.WebGLRenderTarget( textureWidth, textureHeight, parameters );
        renderTarget.texture.generateMipmaps = THREE.Math.isPowerOfTwo( textureWidth ) && THREE.Math.isPowerOfTwo( textureHeight );
    ...
    var mirrorShader =
    {
        uniforms: THREE.UniformsUtils.merge( [
            ...
            THREE.UniformsLib[ 'lights' ],
            {
                ...
                sunColor:           { value: options.sunColor },
                sunDirection:       { value: options.sunDirection },
                eye:                { value: options.eye },
    ...
    scope.onBeforeRender = function ( renderer, scene, camera )
    {
		...
		object.subVectors( mirrorWorldPosition, lookAtPosition );
		object.reflect( normal ).negate();
		object.add( mirrorWorldPosition );

		mirrorCamera.position.copy( view );
		mirrorCamera.up.set( 0, 1, 0 );
		mirrorCamera.up.applyMatrix4( rotationMatrix );
		mirrorCamera.up.reflect( normal );
		mirrorCamera.lookAt( object );
    ...
    scope.getRenderTarget = function()
    {
        return renderTarget;
    }
};
...
THREE.Ocean.prototype.constructor = THREE.Ocean;