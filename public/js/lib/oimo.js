(function (global, factory) {
    ...
    Object.assign( World.prototype, {
        ...
        add: function( o ){
            ...
            var isJoint = type[ 0 ].substring( 0, 5 ) === 'joint';

            if( isJoint ) return this.initJoint( type, o );
        ...
        initBody: function( type, o ){
            ...
            for( var i = 0; i < type.length; i++ ){
                ...
                switch( type[i] )
                {
                    case "sphere":      shape = new Sphere( sc, ...s );     break;
                    case "cylinder":    shape = new Cylinder( sc, ...s );   break;
                    case "box":         shape = new Box( sc, ...s );        break;
